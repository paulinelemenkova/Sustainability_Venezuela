...
\begin{figure}[H]
	...
	\caption{Geoid model %MDPI: The contents of this figure are not legible. In order to convert a clear PDF document, whilst retaining its high quality, we kindly request the provision of figures and schemes at a sufficiently high resolution (min. 1000 pixels width/height, or a resolution of 300 dpi or higher). <-- Answer: provided original file for Figure 4 with a high resolution (1200 dpi, 6,0 MB) instead of previous one (200 dpi, 1,0 MB). 
...
\begin{figure}[H]
	...
	\caption{Free-air %MDPI: The contents of this figure are not legible. In order to convert a clear PDF document, whilst retaining its high quality, we kindly request the provision of figures and schemes at a sufficiently high resolution (min. 1000 pixels width/height, or a resolution of 300 dpi or higher). <-- Answer: provided original file for Figure 5 with a high resolution (1200 dpi, 6,2 MB) instead of previous one (200 dpi, 904 KB). 
...
\begin{figure}[H]
	...
	\caption{Vertical %MDPI: The contents of this figure are not legible. In order to convert a clear PDF document, whilst retaining its high quality, we kindly request the provision of figures and schemes at a sufficiently high resolution (min. 1000 pixels width/height, or a resolution of 300 dpi or higher). <-- Answer: provided original file for Figure 6 with a high resolution (1200 dpi, 7,8 MB) instead of previous one (200 dpi, 1,1 MB). 
...
\newblock In {\em {Abstracts of the International Cartographic Conference
  (ICA)}}; ICA: Bern, Switzerland %MDPI: Please add the location of the publisher (City and Country). <--Added (Bern, Switzerland).
  2019; Chapter~1, p.~51.
...
\newblock In {\em {Surface Exploration Case Histories: Applications of
  Geochemistry, Magnetics, and Remote Sensing}}; AAPG Studies in Geology 48 and SEG Geophysical References Series; AAPG: Tulsa, OK, USA, 2002; Volume~11, \mbox{pp.
  381--392.} %<-- Answer: yes, information is correct.
...
\newblock {\em Geophys. J. Int.} {\bf 1993}, {\em
  112},~507--516.
\newblock {https://doi.org/10.1111/j.1365-246X.1993.tb01184.x}. %MDPI: Short Biography of Authors is not acceptable in this type of articles, we removed them, please note it. <-- Answer: Ok, we agree.
